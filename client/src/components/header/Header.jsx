        ...
        {type !== "list" && (
          <>
            <h1 className="headerTitle">
              Giảm giá trọn đời? Bạn có tin không?
            </h1>
            <p className="headerDesc">
              Nhận phần thưởng cho chuyến du lịch của bạn - tiết kiệm ngay lập tức từ 10% trở lên với tài khoản booking miễn phí
            </p>
            {!user && <button className="headerBtn">Khám phá giảm giá</button>}
